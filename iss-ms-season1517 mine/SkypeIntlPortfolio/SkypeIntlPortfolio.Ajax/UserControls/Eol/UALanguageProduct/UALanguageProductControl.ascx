<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UALanguageProductControl.ascx.cs" Inherits="SkypeIntlPortfolio.Ajax.UserControls.Eol.UALanguageProduct.UALanguageProductControl" %>
<style type="text/css">
    .rgCaption {
        font-weight: bold;
        color: black;
...
<telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="RadGrid_UALanguage">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="RadGrid_UALanguage"></telerik:AjaxUpdatedControl>
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>
</telerik:RadAjaxManagerProxy>
<telerik:RadGrid ID="RadGrid_UALanguage"
    runat="server"
    AllowPaging="True"
    AllowCustomPaging="true"
    CellSpacing="0"
    OnNeedDataSource="RadGrid_UALanguage_NeedDataSource"
    OnItemDataBound="RadGrid_UALanguage_ItemDataBound"
    EnableViewState="true"
    ViewStateMode="Enabled"
    RenderMode="Lightweight"
    PageSize="20"
    OnDetailTableDataBind="RadGrid_UALanguage_DetailTableDataBind"
    EnableEmbeddedSkins="true"
    OnItemCommand="RadGrid_UALanguage_ItemCommand"
    Height="600px">
        ...
        <DetailTables>
            <telerik:GridTableView
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="Quality" DataField="QualityName">
                    </telerik:GridBoundColumn>
                    ...
                    <FormTemplate>
                        <div class="container-fluid" style="margin-top: 10px;">
                            <asp:Panel runat="server" ID="pannel_add" Visible="false">
                                <telerik:RadTabStrip runat="server" AutoPostBack="True" ID="RadTabStripUALanguage" MultiPageID="radMultiPageUaLanguage" SelectedIndex="0" CausesValidation="False">
                                    <Tabs>
                                ...
                                <telerik:RadMultiPage runat="server" ID="radMultiPageUaLanguage" SelectedIndex="0" Width="100%" Height="100%" RenderSelectedPageOnly="true">
                                    ...
                                    <telerik:RadPageView runat="server" ID="radPageView_languageSeleciton">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <telerik:RadComboBox runat="server" ID="radcombobox_Quality">
                                                    <Items>
                                                        <telerik:RadComboBoxItem Value="1" Text="Auto" />
                                                        <telerik:RadComboBoxItem Value="2" Text="HT" Selected="true" />
                                                        <telerik:RadComboBoxItem Value="3" Text="MT" />
                                                    </Items>
                                                </telerik:RadComboBox>
                                            </div>
                                        </div>
                                    ...
                                    <telerik:RadPageView runat="server" ID="radPageView_CopyFromProject">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <telerik:RadComboBox runat="server" ID="radCombobox_UAorUI">
                                                    <Items>
                                                        <telerik:RadComboBoxItem Value="UA" Text="UA" />
                                                        <telerik:RadComboBoxItem Value="UI" Text="UI" />
                                                    </Items>
                                                </telerik:RadComboBox>
                                            </div>
                                        </div>
                            ...
                            <asp:Panel runat="server" ID="pannel_edit" Visible="false">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Label runat="server" Text="Quality:"></asp:Label>
                                        <telerik:RadComboBox ID="radcombobox_Quality_Edit" runat="server">
                                            <Items>
                                                <telerik:RadComboBoxItem Value="1" Text="Auto" />
                                                <telerik:RadComboBoxItem Value="2" Text="HT" />
                                                <telerik:RadComboBoxItem Value="3" Text="MT" />
                                            </Items>
                                        </telerik:RadComboBox>
                                    </div>
