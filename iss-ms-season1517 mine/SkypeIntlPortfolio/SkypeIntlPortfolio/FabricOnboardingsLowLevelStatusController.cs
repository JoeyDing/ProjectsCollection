...
{
    /// <summary>
    /// Web API Controller for FabricOnboardingsLowLevelStatus entity defined in SkypeIntlPortfolio.Data.EOLandProductsEntities data model
    /// </summary>
    public partial class FabricOnboardingsLowLevelStatusController : OpenAccessBaseApiController<SkypeIntlPortfolio.Data.FabricOnboardingsLowLevelStatus, SkypeIntlPortfolio.Data.EOLandProductsEntities>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public FabricOnboardingsLowLevelStatusController()
        {
            this.repository = new FabricOnboardingsLowLevelStatusRepository();
        }
        ...
        public FabricOnboardingsLowLevelStatusController(IOpenAccessBaseRepository<SkypeIntlPortfolio.Data.FabricOnboardingsLowLevelStatus , SkypeIntlPortfolio.Data.EOLandProductsEntities> repository)
        {
        ...
        public virtual SkypeIntlPortfolio.Data.FabricOnboardingsLowLevelStatus Get(String id)
        {
            SkypeIntlPortfolio.Data.FabricOnboardingsLowLevelStatus entity = repository.GetBy(s => s.Project == id);
        ...
        public virtual HttpResponseMessage Put(String id, SkypeIntlPortfolio.Data.FabricOnboardingsLowLevelStatus entity)
        {
                        if (entity == null ||
                id != entity.Project)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, SkypeIntlPortfolio.Data.FabricOnboardingsLowLevelStatus entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<SkypeIntlPortfolio.Data.FabricOnboardingsLowLevelStatus>(httpStatusCode, entityToEmbed);
