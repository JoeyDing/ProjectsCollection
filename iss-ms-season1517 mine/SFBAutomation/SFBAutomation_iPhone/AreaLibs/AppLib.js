...
{
	var contactsButton = MainWindow.buttons()[GetValueFromKey("LOCID ACCESSIBILITY_TIMELINE_BUTTON_CONTACTS")];
	ElementValidAndVisible(contactsButton);
	contactsButton.tap();
}	
...
function GotoMeetings()
{
	...
	var meetingsButton = MainWindow.buttons()[GetValueFromKey("LOCID ACCESSIBILITY_TIMELINE_BUTTON_MEETINGS")];
	ElementValidAndVisible(meetingsButton);
	meetingsButton.tap();
}
