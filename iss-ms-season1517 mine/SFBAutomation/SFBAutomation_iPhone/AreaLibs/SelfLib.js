...
function SetHappeningNote(note)
{
	...
	var note_emptyfield = MainWindow.tableViews()[0].cells()[GetValueFromKey("LOCID MY_INFO_EMPTY_MOOD_MESSAGE")];
    var note_field = MainWindow.tableViews()[0].cells()[GetValueFromKey("LOCID MY_INFO_MOOD_MESSAGE")]
...
//	{
		...
		try
		{
            ...
            if(note_field.isVisible() == true && note_field.isValid() == true) {
