...
function SignInConfigTest(sipUri,password)
{
    ...
    if(sipUriField.isVisible() == false && sipUriField.isValid() == false){
        
        tableView = mainWindow.tableViews()[2];
        
        sipUriField = tableView.cells()[0].elements()[0];
        passwordField = tableView.cells()[1].elements()[0];
    }
...
function VerifySignInAndSignOutSuccessfulTest() {
    ...
    if(returnValue == 0){
        ...
        var signoutButton =  MainWindow.tableViews()[1].cells()[GetValueFromKey("LOCID Sign Out")];
    ...
    if(tableView.isValid() == true){
        ...
        if(returnValue == 0){
            ...
            if(isSignin == false) {
                ...
                var signoutButton =  MainWindow.tableViews()[1].cells()["Sign Out"];
