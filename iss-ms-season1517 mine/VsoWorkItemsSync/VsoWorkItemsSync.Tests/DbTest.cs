...
namespace VsoWorkItemsSync.Tests
{
    ...
    public class DbTest
    {
        ...
        public static void ClassInitialize(TestContext context)
        {
            ...
            _dbConnectionString = @"data source=skypeintl;initial catalog=SkypeVsoWorkItems;integrated security=True;MultipleActiveResultSets=True;App=VsoWorkItemsSync";
        }

        [TestMethod]
        public void Db_RunQuery_Sucess()
        {
            //prepare
            ...
            try
            {
                ...
                new WorkItemProvider(configMapping, configMapping.Mappings[0]).RunDbQuery();
            }
            catch (Exception e)
            {
