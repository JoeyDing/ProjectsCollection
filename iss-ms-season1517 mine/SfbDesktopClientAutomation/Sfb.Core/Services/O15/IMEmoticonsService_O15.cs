...
{
    public class IMEmoticonsService_O15 : IIMEmoticonsTest
    {
        ...
        public IMEmoticonsService_O15(IExecuteAction _execute,
            IRunApp _runApp,
        ...
        public bool Options_IM_Emoticons(string languageShortName, TestCase testCase)
        {
            ...
            UIItemCollection items = execute.ExecuteAction(
               ...
               {
                   return selectOptionWindowTabByIndex.SelectOptionWindowTabByIndex(6, option_window);
               }
           );
            ...
            execute.ExecuteAction(
                "make a screenshot of window", () =>
                {
                    ...
                    string filePath = Path.Combine(langFolder, "IM Emoticons_IM Emoticons.png");
