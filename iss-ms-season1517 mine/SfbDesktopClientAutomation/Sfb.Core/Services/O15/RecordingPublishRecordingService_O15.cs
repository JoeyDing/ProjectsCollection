...
{
    public class RecordingPublishRecordingService_O15 : IRecordingPublishRecordingTest
    {
        ...
        public RecordingPublishRecordingService_O15(IExecuteAction _execute,
            IRunApp _runApp,
        ...
        public bool Recording_Publish_Recording(string languageShortName, TestCase testCase)
        {
            ...
            //var childMenue = meetNowWrapper.ChildMenus[1];
            //childMenue.Click();
            ...
            var recording_windows = appForRecording.GetWindows().Where(w => w.Name != sfbClient.Name);
            Window recordingmanagerwindow = recording_windows.First();
