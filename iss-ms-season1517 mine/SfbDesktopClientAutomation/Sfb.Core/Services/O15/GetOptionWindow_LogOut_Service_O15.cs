...
{
    public class GetOptionWindow_LogOut_Service_O15 : IGetOptionWindow_LogOut
    {
        private readonly ITraverseItemNative traverse;

        public GetOptionWindow_LogOut_Service_O15(ITraverseItemNative _traverse)
        {
            traverse = _traverse;
        }
        ...
        public Window GetOptionWindow_LogOut(Window sfbClient, Application app)
        {
            ...
            var traverseItemNativeFile = traverseItemNative.Item2.Items[7].Items[0].Items[1].Items[0].Items[1].Items[0];
            //create wrapper for element
            var signout_wrapper = new TestStack.White.UIItems.MenuItems.Menu(traverseItemNativeFile.Element, pane_contact.ActionListener);
            ...
            //get contact pane
            (panes1[1] as Panel).Items[5].Click();
