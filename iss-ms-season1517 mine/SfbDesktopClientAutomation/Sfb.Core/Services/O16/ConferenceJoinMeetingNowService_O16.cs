...
{
    public class ConferenceJoinMeetingNowService_O16 : IConferenceJoinMeetingNowTest
    {
        ...
        public ConferenceJoinMeetingNowService_O16(IExecuteAction _execute,
            IRunApp _runApp,
        ...
        public bool ConferenceJoin_MeetNow(string languageShortName, TestCase testCase)
        {
            ...
            execute.ExecuteAction(
                    "Take a full screenshot of window", () =>
                    {
                        ...
                        takeFullScreenShot.SaveScreenshot(filePath, screenshot);
