...
{
    public class PhonesService_O16 : IPhonesTest
    {
        ...
        public PhonesService_O16(IExecuteAction _execute,
            IRunApp _runApp,
        ...
        public bool Options_Phones(string languageShortName, TestCase testCase)
        {
            ...
            UIItemCollection items = execute.ExecuteAction(
               ...
               {
                   return selectOptionWindowTabByIndex.SelectOptionWindowTabByIndex(4, option_window);
               }
           );
            ...
            execute.ExecuteAction(
               "Take a screenshot of window", () =>
               {
                   ...
                   string filePath = Path.Combine(langFolder, "Phones.png");
