...
{
    public class RingtonesAndSoundsService_O16 : IRingtonesAndSoundsTest
    {
        ...
        public RingtonesAndSoundsService_O16(IExecuteAction _execute,
            IRunApp _runApp,
        ...
        public bool Options_RingtonesAndSounds(string languageShortName, TestCase testCase)
        {
            ...
            UIItemCollection items = execute.ExecuteAction(
               ...
               {
                   return selectOptionWindowTabByIndex.SelectOptionWindowTabByIndex(8, option_window);
               }
           );
            ...
            execute.ExecuteAction(
                "make a screenshot of window", () =>
                {
                    ...
                    string filePath = Path.Combine(langFolder, "Ringtones and Sounds_Ringtones and Sounds.png");
