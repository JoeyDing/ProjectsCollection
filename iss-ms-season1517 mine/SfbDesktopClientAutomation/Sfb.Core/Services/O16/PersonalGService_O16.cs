...
{
    public class PersonalGService_O16 : IPersonalGTest
    {
        ...
        public PersonalGService_O16(IExecuteAction _execute,
            IRunApp _runApp,
        ...
        public bool Options_PersonalG(string languageShortName, TestCase testCase)
        {
            ...
            UIItemCollection items = execute.ExecuteAction(
               ...
               {
                   return selectOptionWindowTabByIndex.SelectOptionWindowTabByIndex(0, option_window);
               }
           );
            ...
            execute.ExecuteAction(
               "make a screenshot of window", () =>
               {
                   ...
                   string filePath = Path.Combine(langFolder, "PersonalG_PersonalGTab.png");
