    ...
    public abstract class SfbBVT
    {
        ...
        public virtual bool ConferenceJoin_MeetNow()
        {
            ...
            this.ExecuteAction(
                "make a screenshot of window", () =>
                {
                    this.TakeFullScreenShot(app, "ConferenceJoin_MeetNow.png", ImageFormat.Png);
                }
            );
...
<<<<<<< HEAD
        public virtual bool Recording_Publish_Recording()
        {
            var app = this.ExecuteAction(
                "get instance of app", () =>
                {
            ...
            var button = menu_pane.Get<Button>(SearchCriteria.ByControlType(ControlType.Button));
            return true;
        }
        
=======
>>>>>>> bfaef08ef62ab4bea5fe81c8161524867874bc22
        #endregion BVT
    }
}